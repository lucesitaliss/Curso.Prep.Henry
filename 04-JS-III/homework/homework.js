...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
//   var sumanvalores = resultadosTest[0];
//   for (var i=1; i<resultadosTest.length ; i++){
//     sumanvalores = sumanvalores + resultadosTest[i];
//   }
// return sumanvalores/resultadosTest.length;
